...
//    public static final String QB_AUTH_SECRET = "xS2uerEveGHmEun";
    ...
    public static final String QB_APP_ID = "42027";
    public static final String QB_AUTH_KEY = "PWwpVZfOEqcAuYd";
    public static final String QB_AUTH_SECRET = "xtatcMChbg4dKuH";
